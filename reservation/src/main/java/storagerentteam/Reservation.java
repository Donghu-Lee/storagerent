...
public class Reservation {
    ...
    public void onPostPersist(){
        ...
        storagerentteam.external.Storage storage = new storagerentteam.external.Storage();
        // mappings goes here
        Application.applicationContext.getBean(storagerentteam.external.StorageService.class)
